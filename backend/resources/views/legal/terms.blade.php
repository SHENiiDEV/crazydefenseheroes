...
@section('content')
    ...
    <h2>1. The service</h2>
    <p>Crazy Defense Heroes is an online tower defense game with endless waves, digital items, boosts and diamond top-ups. You must use the service lawfully and keep your account secure.</p>
